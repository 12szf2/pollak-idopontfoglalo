...
<div class="main">
    ...
    <div class="kismain">
        ...
        <div class="text">
            ...
            <h3 class="idopont"><?php $datum = new DateTime($data['reszletek']->datum);
                                echo $datum->format('Y.m.d. H:i'); ?></h3>
            <br><br><br>
        ...
        <?php foreach ($data["jelentkezok"] as $sor): ?>
            <div class="lista">
                <h3>Neve: <?php echo $sor->neve ?>, Email címe: <?php echo $sor->email ?>
                    ...
                    <a class="jelentkezoTorles" onclick="return confirm('Biztos törölni szeretnéd?')" href="<?php echo URLROOT ?>/admin/felhasznaloTorles/<?php echo  $data["reszletek"]->esemeny_id ?>/<?php echo $sor->jelentkezoID ?>"><i class='bx bxs-trash'></i></a>
                </h3>
